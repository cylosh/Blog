   ...
   <div class="container">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
         <ul class="nav navbar-nav">
            <li class="dropdown <?php if(defined("MENU_ACTIVE") && MENU_ACTIVE == 'index') echo 'active'; ?>">
            ...
            <li class="dropdown">
               ...
               <ul class="dropdown-menu">
                  ...
                  <li><a href="https://www.freelancer.com/affiliates/email/4790347/">REQUEST A QUOTE <i class="fa fa-wrench" aria-hidden="true"></i></a>
